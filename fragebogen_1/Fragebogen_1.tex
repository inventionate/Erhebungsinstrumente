...
\begin{document}
  ...
  \begin{questionnaire}[noinfo]
    ...
    \input{allgemeine_informationen/intro}
    ...
    % EIGENE PERSON
    \input{biografischer_hintergrund/person}

    % ELTERN
    \input{biografischer_hintergrund/eltern}

	% KIDNHEIT UND JUGEND
	\input{biografischer_hintergrund/kindheit}

	% SCHULZEIT
	\input{biografischer_hintergrund/schulzeit}
	...
	\input{uebergang_schule_hochschule/uebergang}

    % ÜBERGANG SCHULE – HOCHSCHULE
	\input{uebergang_schule_hochschule/studienwahlmotive}

    % ÜBERGANG SCHULE – HOCHSCHULE
	\input{uebergang_schule_hochschule/studienwahl}
	...
	\input{studienalltag/situation}

	% EINE GWÖHNLICHE STUDIENWOCHE
	\input{studienalltag/studienwoche}

	% GEWÖHNLICHE STUDIENTÄTIGKEITEN INNERHALB EINER WOCHE
	\input{studienalltag/studientaetigkeiten}

	% GEWÖHNLICHE FREIZEITAKTIVITÄTEN INNERHALB EINER WOCHE
	\input{studienalltag/freizeitaktivitaeten}
	...
	\input{allgemeine_informationen/extro}
