...
\begin{document}
  ...
  \begin{questionnaire}[noinfo]
    ...
    \input{allgemeine_informationen_intro}
    ...
    % EIGENE PERSON
    \input{biografischer_hintergrund_person}

    % ELTERN
    \input{biografischer_hintergrund_eltern}

	% KIDNHEIT UND JUGEND
	\input{biografischer_hintergrund_kindheit}

	% SCHULZEIT
	\input{biografischer_hintergrund_schulzeit}
    ...
    % ÜBERGANG SCHULE – HOCHSCHULE
	\input{uebergang_schule_hochschule_studienwahlmotive}

    % ÜBERGANG SCHULE – HOCHSCHULE
	\input{uebergang_schule_hochschule_studienwahl}
	...
	\input{studienalltag_situation}

	% EINE GWÖHNLICHE STUDIENWOCHE
	\input{studienalltag_studienwoche}
	...
	\input{allgemeine_informationen_extro}
